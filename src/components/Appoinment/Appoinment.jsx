...
const handleSubmit = async (e) => {
  ...
  const { service_id, name, email, phone, appointment_date, appointment_time, message } = formData;

  if (!service_id || !name || !email || !phone || !appointment_time || !appointment_date) {
    toast.error("Please fill in all required fields.");
    setBooking(false);
    return;
  }
  ...
  try {
    ...
    toast.error(err?.detail || err?.message || "Failed to book appointment.");
  } finally {
    setBooking(false);
  }
};
          ...
          <div className="md:w-1/2  bg-white rounded-2xl p-3 lg:p-6 shadow min-h-[480px] flex flex-col justify-between lg:h-[800px] md:h-[780px] sm:h-full">
            <div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                {/* Service */}
                <div>
                  <label htmlFor="service_id" className="block mb-1 font-medium text-gray-700">Select Service</label>
                  <select
                    id="service_id"
                ...
                <div className="flex gap-4">
                  <div className="w-1/2">
                    <label htmlFor="appointment_date" className="block mb-1 font-medium text-gray-700">Date</label>
                    <input
                      id="appointment_date"
                      type="date"
                  ...
                  <div className="w-1/2">
                    <label htmlFor="appointment_time" className="block mb-1 font-medium text-gray-700">Time</label>
                    <select
                      id="appointment_time"
