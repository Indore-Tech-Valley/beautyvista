      ...
      import { FAQS_BASE_URL, ADMIN_FAQS_URL  , authToken} from "../../../../config";
      ...
      export const fetchFAQs = createAsyncThunk("faqs/fetchAll", async (_, { rejectWithValue }) => {
        try {
          ...
          return rejectWithValue(error.response?.data || "An error occurred while fetching FAQs");
        }
      });

      export const fetchAdminFAQs = createAsyncThunk("faqs/fetchAll", async (_, { rejectWithValue }) => {
        try {
      ...
      // ➕ Add FAQ (admin)
      export const addFAQ = createAsyncThunk("faqs/add", async (faqData, { rejectWithValue }) => {
        try {
          const response = await axios.post(`${ADMIN_FAQS_URL}/create-faq`, faqData , 
            {
                      headers: {
                        "Content-Type": "application/json",
                        Authorization: `Bearer ${authToken}`
          ...
          return rejectWithValue(error.response?.data || "An error occurred while adding FAQ");
        }
      });

      // ✏️ Update FAQ (admin)
      export const updateFAQ = createAsyncThunk("faqs/update", async ({ id, updates }, { rejectWithValue }) => {
        try {
          const response = await axios.patch(`${ADMIN_FAQS_URL}/update-faq/${id}`, updates , 
            {
                      headers: {
                        "Content-Type": "application/json",
                        Authorization: `Bearer ${authToken}`
          ...
          return rejectWithValue(error.response?.data.detail || "An error occurred while updating FAQ");
        }
      });
      ...
      export const deleteFAQ = createAsyncThunk("faqs/delete", async (id, { rejectWithValue }) => {
        try {
          ...
          return rejectWithValue(error.response?.data || "An error occurred while deleting FAQ");
        }
      }
      );
      ...
      export const updateFAQStatus = createAsyncThunk(
        ...
        async ({ id, status }, { rejectWithValue }) => {
          try {
            ...
            const response = await axios.put(`${ADMIN_FAQS_URL}/update-status/${id}`, formData, {
              headers: {
