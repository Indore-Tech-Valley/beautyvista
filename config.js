...
export const BASE_URL="http://192.168.1.122:8000/api/v1"
...
export const CONFIGS_URL=`${BASE_URL}/web-configs`;
...
// export const ADMIN_BASE_URL="http://192.168.1.118:8000/api/v1/admin"
...
export const ADMIN_PROFILE_URL = `${ADMIN_BASE_URL}`
